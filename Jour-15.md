...
- [x] Découvrir le maquettage d'interface d'une application
  - [x] Comprendre la différence entre :
    - [x] Zoning <!--- représentation  visuelle de la dispo des éléments sur écran sans se préoccuper des détails graph et esthé. --->
    - [x] Wireframe <!--- monte la dispositon des éléments ainsi que leur relation les uns avec les autres. --->
    - [x] Mockup <!--- utiliser pr présenter le design final aux partie prenantes et pr obtenir des feedbacks sur l'apparence générale de l'interface. --->
    - [x] Maquette <!--- souvent utiliser pour des test d'utilisabilité pour valider le fonctionnement de l'interface avec le développement --->
